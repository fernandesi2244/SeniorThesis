...
class NumericPredictor:
    def __init__(self, final_model_path='final_models/numeric_final_model.joblib', 
                 results_model_dir='../SEPPrediction/results/numeric_data/'):
        """
    ...
    def load_models(self):
        ...
        print(f"Loading final numeric model from {self.final_model_path}")
        ...
        print(f"\nLoading results numeric model from {self.results_model_path}")
    ...
    def create_ccmc_json(self, input_dt, prediction_result, model_type='final', output_path=None, issueTime=None):
        ...
        ccmc_json = {
            "sep_forecast_submission": {
                "model": {
                    "short_name": f"MagPy_ML_SHARP_HMI_CEA_numeric{model_suffix}",
                    "spase_id": f"spase://CCMC/SimulationModel/MagPy-ML/numeric{model_suffix}/v1"
                },
                "mode": "forecast",
    ...
    def predict_and_export(self, feature_vector, input_dt, output_dir='predictions/numeric', issueTime=None):
        ...
        base_filename = f'MagPy-ML-HMI-SHARP-Vector-numeric.{dt_parsed.year:04d}{dt_parsed.month:02d}{dt_parsed.day:02d}T{dt_parsed.hour:02d}{dt_parsed.minute:02d}.{issueTime.year:04d}{issueTime.month:02d}{issueTime.day:02d}T{issueTime.hour:02d}{issueTime.minute:02d}'
