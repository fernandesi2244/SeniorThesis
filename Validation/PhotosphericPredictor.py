...
def main():
    """
    Example usage of the PhotosphericPredictor
    """
    try:
        ...
        # Photospheric feature vector components (based on PhotosphericDataLoader.py):
        # 
        ...
        # Per-blob vector columns (17 features per blob per timestep):
        # ['Latitude', 'Carrington Longitude', 'Gradient_00', 'Gradient_10', 'Gradient_30', 
        ...
        # For per-disk-4hr granularity: 11 + (5 blobs × 6 timesteps × 17 features) = 11 + 510 = 521 features
        ...
        your_feature_vector = [
            ...
            # Blob data for 5 blobs × 6 timesteps × 17 features (510 values total)
            # REPLACE ALL THESE ZEROS WITH YOUR ACTUAL DATA
            *([0.0] * 510)  # 510 zeros as placeholder - replace with your blob timeseries data
        ]
        ...
        print("Expected length for photospheric per-disk-4hr: 521")
        
        if len(your_feature_vector) != 521:
