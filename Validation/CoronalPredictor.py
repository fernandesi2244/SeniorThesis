...
class CoronalPredictor:
    def __init__(self, model_path='final_models/coronal_final_model.joblib'):
        """
    ...
    def load_model(self):
        ...
        print(f"Loading coronal model from {self.model_path}")
    ...
    def create_ccmc_json(self, input_dt, prediction_result, output_path=None, issueTime=None):
        ...
        ccmc_json = {
            "sep_forecast_submission": {
                "model": {
                    "short_name": "MagPy_ML_SHARP_HMI_CEA_coronal",
                    "spase_id": "spase://CCMC/SimulationModel/MagPy-ML/coronal/v1"
                },
                "mode": "forecast",
    ...
    def predict_and_export(self, feature_vector, input_dt, output_dir='predictions/coronal', issueTime=None):
        ...
        # Create filename
        filename = f'MagPy-ML-HMI-SHARP-Vector-coronal.{dt_parsed.year:04d}{dt_parsed.month:02d}{dt_parsed.day:02d}T{dt_parsed.hour:02d}{dt_parsed.minute:02d}.{issueTime.year:04d}{issueTime.month:02d}{issueTime.day:02d}T{issueTime.hour:02d}{issueTime.minute:02d}.json'
