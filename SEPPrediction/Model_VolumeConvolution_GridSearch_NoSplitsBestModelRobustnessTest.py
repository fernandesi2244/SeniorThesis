...
def main():
    ...
    granularities = ['per-disk-4hr'] # per-blob not coded in ModelConstructor yet

    oversampling_ratios = [0.1] # pos:neg ratio.

    model_types = [
        # 'conv_nn_on_slices_and_cube',
        # 'conv_nn_on_cube',
        'conv_nn_on_cube_simple_just_cube',
        'conv_nn_on_cube_simple_recent_events',
    ...
    for model_type in model_types:
        ...
        for granularity in granularities:
            ...
            elif model_type == 'conv_nn_on_cube' or model_type == 'conv_nn_on_cube_simple' or model_type == 'conv_nn_on_cube_complex' or model_type == 'conv_nn_on_cube_simple_just_cube' or model_type == 'conv_nn_on_cube_simple_recent_events':
