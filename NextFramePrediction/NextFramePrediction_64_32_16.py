...
batch_size = 5
target_size = (256, 256)  # Adjust based on which series we're using
...
checkpoint = keras.callbacks.ModelCheckpoint("next_frame_prediction_64_32_16_checkpoint.keras", save_best_only=True)
...
# Save the model
model.save('next_frame_prediction_64_32_16.keras')
