...
df = pd.read_csv("../InputData/volume_parameterizations_single_blob_carved_exactly.csv")
...
print(df['Total Unsigned Current Helicity'].describe())

plt.subplot(2, 5, 2)
plt.hist(df['Total Unsigned Current Helicity'], bins=30)
...
print(df['Total Absolute Net Current Helicity'].describe())

plt.subplot(2, 5, 3)
plt.hist(df['Total Absolute Net Current Helicity'], bins=30)
...
print(df['Mean Shear Angle'].describe())

plt.subplot(2, 5, 4)
plt.hist(df['Mean Shear Angle'], bins=30)
...
print(df['Total Unsigned Volume Vertical Current'].describe())

plt.subplot(2, 5, 5)
plt.hist(df['Total Unsigned Volume Vertical Current'], bins=30)
...
print(df['Twist Parameter Alpha'].describe())

plt.subplot(2, 5, 6)
plt.hist(df['Twist Parameter Alpha'], bins=30)
...
print(df['Mean Gradient of Vertical Magnetic Field'].describe())

plt.subplot(2, 5, 7)
plt.hist(df['Mean Gradient of Vertical Magnetic Field'], bins=30)
...
print(df['Mean Gradient of Total Magnetic Field'].describe())

plt.subplot(2, 5, 8)
plt.hist(df['Mean Gradient of Total Magnetic Field'], bins=30)
...
print(df['Total Magnitude of Lorentz Force'].describe())

plt.subplot(2, 5, 9)
plt.hist(df['Total Magnitude of Lorentz Force'], bins=30)
...
print(df['Total Unsigned Magnetic Flux'].describe())

plt.subplot(2, 5, 10)
plt.hist(df['Total Unsigned Magnetic Flux'], bins=30)
