...
def generate_slices_and_cubes(volume_path):
    # Reset volume_dir to the dir of volume_path and volume_path to the filename
...
def main():
    ...
    generate_slices_and_cubes(volume_path)
